...
//!
//! Distilled from `uvm-tests/tests/40phasing/50phase_controls/01simple` (UV TEST
//! TIMEOUT / sequence never started). The root cause lives in the sequencer's
//! `start_phase_sequence`: it does
//!
