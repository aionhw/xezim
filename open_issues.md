...
### L7–L10, L13–L18, L20 — front-end acceptance batch 2 (swept)
7-case matrix (scratchpad/l31/): `let`, concurrent `assert property`, and
specify path delays already reference-exact; `extern module` prototypes now
